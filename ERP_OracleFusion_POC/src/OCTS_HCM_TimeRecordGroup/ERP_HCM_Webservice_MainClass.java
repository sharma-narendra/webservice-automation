	...
	public  void OracleCloud_Financial_Webservices(String inputfile_fp,String file_fp) throws Exception {
       ...
       //    conn.setRequestProperty("Authorization", "Basic " + auth);
		 ...
		 */
           ...
           if(booleanstatus){
        	   ERP_TimeRecordGroup_uploadFileToUcm euftu = new ERP_TimeRecordGroup_uploadFileToUcm();
			 ...
			 */
		   if(booleanstatus){
			   ERP_TimeRecordGroup_submitESSJobRequest_Loader esejr = new ERP_TimeRecordGroup_submitESSJobRequest_Loader();
		   ...
		   if(booleanstatus){
			   ...
			   ERP_TimeRecordGroup_getESSJobStatus egejs = new ERP_TimeRecordGroup_getESSJobStatus();
		   ...
		   if(booleanstatus){
			   ...
			   ERP_TimeRecordGroup_submitESSJobRequest_RequestImport esejri = new ERP_TimeRecordGroup_submitESSJobRequest_RequestImport();
		   			...
		   			if(booleanstatus){
		   				ERP_TimeRecordGroup_getESSJobStatus egejsi = new ERP_TimeRecordGroup_getESSJobStatus();
						...
						/*
							 ...
							 */
		   					if(booleanstatus){
		   						...
		   						ERP_TimeRecordGroup_downloadESSJobExecutionDetails edejed = new ERP_TimeRecordGroup_downloadESSJobExecutionDetails();
