...
package OCTS_HCM_ScheduleAssignment;
import java.io.File;
	...
	public  void OracleCloud_Financial_Webservices(String inputfile_fp,String file_fp) throws Exception {
       ...
       //    conn.setRequestProperty("Authorization", "Basic " + auth);
		 ...
		 */
           ...
           if(booleanstatus){
        	   ERP_ScheduleAssignment_uploadFileToUcm euftu = new ERP_ScheduleAssignment_uploadFileToUcm();
			 ...
			 */
		   if(booleanstatus){
			   ERP_ScheduleAssignment_submitESSJobRequest_Loader esejr = new ERP_ScheduleAssignment_submitESSJobRequest_Loader();
		   ...
		   if(booleanstatus){
			   ...
			   ERP_ScheduleAssignment_getESSJobStatus egejs = new ERP_ScheduleAssignment_getESSJobStatus();
		   ...
		   if(booleanstatus){
			   ...
			   ERP_ScheduleAssignment_submitESSJobRequest_RequestImport esejri = new ERP_ScheduleAssignment_submitESSJobRequest_RequestImport();
		   			...
		   			if(booleanstatus){
		   				ERP_ScheduleAssignment_getESSJobStatus egejsi = new ERP_ScheduleAssignment_getESSJobStatus();
						...
						/*
							 ...
							 */
		   					if(booleanstatus){
		   						...
		   						ERP_ScheduleAssignment_downloadESSJobExecutionDetails edejed = new ERP_ScheduleAssignment_downloadESSJobExecutionDetails();
