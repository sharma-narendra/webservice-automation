...
package OCTS_HCM_BenefitGroup_Employee_AutomationTestCases;
import java.io.File;
...
import OCTS_HCM_BenefitGroup_Employee_Webservices.ERP_BenefitGroup_downloadESSJobExecutionDetails;
import OCTS_HCM_BenefitGroup_Employee_Webservices.ERP_BenefitGroup_getESSJobStatus;
import OCTS_HCM_BenefitGroup_Employee_Webservices.ERP_BenefitGroup_submitESSJobRequest_Loader;
import OCTS_HCM_BenefitGroup_Employee_Webservices.ERP_BenefitGroup_submitESSJobRequest_RequestImport;
import OCTS_HCM_BenefitGroup_Employee_Webservices.ERP_BenefitGroup_uploadFileToUcm;
	...
	public  void OracleCloud_Financial_Webservices(String inputfile_fp,String file_fp) throws Exception {
       ...
       //    conn.setRequestProperty("Authorization", "Basic " + auth);
		 ...
		 */
           ...
           if(booleanstatus){
        	   ERP_BenefitGroup_uploadFileToUcm euftu = new ERP_BenefitGroup_uploadFileToUcm();
			 ...
			 */
		   if(booleanstatus){
			   ERP_BenefitGroup_submitESSJobRequest_Loader esejr = new ERP_BenefitGroup_submitESSJobRequest_Loader();
		   ...
		   if(booleanstatus){
			   ...
			   ERP_BenefitGroup_getESSJobStatus egejs = new ERP_BenefitGroup_getESSJobStatus();
		   ...
		   if(booleanstatus){
			   ...
			   ERP_BenefitGroup_submitESSJobRequest_RequestImport esejri = new ERP_BenefitGroup_submitESSJobRequest_RequestImport();
		   			...
		   			if(booleanstatus){
		   				ERP_BenefitGroup_getESSJobStatus egejsi = new ERP_BenefitGroup_getESSJobStatus();
						...
						/*
							 ...
							 */
		   					if(booleanstatus){
		   						...
		   						ERP_BenefitGroup_downloadESSJobExecutionDetails edejed = new ERP_BenefitGroup_downloadESSJobExecutionDetails();
