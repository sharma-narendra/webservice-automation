	...
	public  void OracleCloud_Financial_Webservices(String inputfile_fp,String file_fp) throws Exception {
       ...
       //    conn.setRequestProperty("Authorization", "Basic " + auth);
		 ...
		 */
           ...
           if(booleanstatus){
        	   ERP_Salary_uploadFileToUcm euftu = new ERP_Salary_uploadFileToUcm();
			 ...
			 */
		   if(booleanstatus){
			   ERP_Salary_submitESSJobRequest_Loader esejr = new ERP_Salary_submitESSJobRequest_Loader();
		   ...
		   if(booleanstatus){
			   ...
			   ERP_Salary_getESSJobStatus egejs = new ERP_Salary_getESSJobStatus();
		   ...
		   if(booleanstatus){
			   ...
			   ERP_Salary_submitESSJobRequest_RequestImport esejri = new ERP_Salary_submitESSJobRequest_RequestImport();
		   			...
		   			if(booleanstatus){
		   				ERP_Salary_getESSJobStatus egejsi = new ERP_Salary_getESSJobStatus();
						...
						/*
							 ...
							 */
		   					if(booleanstatus){
		   						...
		   						ERP_Salary_downloadESSJobExecutionDetails edejed = new ERP_Salary_downloadESSJobExecutionDetails();
