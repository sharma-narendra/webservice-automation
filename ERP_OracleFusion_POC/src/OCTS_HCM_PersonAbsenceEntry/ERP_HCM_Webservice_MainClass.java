...
package OCTS_HCM_PersonAbsenceEntry;
import java.io.File;
	...
	public  void OracleCloud_Financial_Webservices(String inputfile_fp,String file_fp) throws Exception {
       ...
       //    conn.setRequestProperty("Authorization", "Basic " + auth);
		 ...
		 */
           ...
           if(booleanstatus){
        	   ERP_PersonAbsence_uploadFileToUcm euftu = new ERP_PersonAbsence_uploadFileToUcm();
			 ...
			 */
		   if(booleanstatus){
			   ERP_PersonAbsence_submitESSJobRequest_Loader esejr = new ERP_PersonAbsence_submitESSJobRequest_Loader();
		   ...
		   if(booleanstatus){
			   ...
			   ERP_PersonAbsence_getESSJobStatus egejs = new ERP_PersonAbsence_getESSJobStatus();
		   ...
		   if(booleanstatus){
			   ...
			   ERP_PersonAbsence_submitESSJobRequest_RequestImport esejri = new ERP_PersonAbsence_submitESSJobRequest_RequestImport();
		   			...
		   			if(booleanstatus){
		   				ERP_PersonAbsence_getESSJobStatus egejsi = new ERP_PersonAbsence_getESSJobStatus();
						...
						/*
							 ...
							 */
		   					if(booleanstatus){
		   						...
		   						ERP_PersonAbsence_downloadESSJobExecutionDetails edejed = new ERP_PersonAbsence_downloadESSJobExecutionDetails();
